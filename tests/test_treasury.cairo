...
fn test_deposit_withdraw_carmine() {
    ...
    let carm_AMM: IAMMDispatcher = IAMMDispatcher { contract_address: _AMM_contract_address };
    let lp_token_addr = carm_AMM.get_lptoken_address_for_given_option(usdc_addr, eth_addr, 0);
